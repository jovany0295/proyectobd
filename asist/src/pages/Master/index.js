...
export  class Master extends Component {
  ...
  insertModal = () => {
    this.state.tituloModal = 'Registrar Maestro';
...
console.log(this.state.form);
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-4">
    <button className="btn btn-success" onClick={this.insertModal}>Agregar Maestro</button>
    <ModalData 
      isOpen = {this.state.showModal} 
      close = {this.insertModal} 
      tipo = {'insertar'}
      tituloModal = {'Guardar Maestro'}
      endpoint = { this.peticionPost } 
      formData = { form }  
