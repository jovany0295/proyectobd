...
const PageNotFound = () => {
    ...
    return (
        <div class="container container-404">
            ...
            <div class="col-md-6 align-self-center">
                <h1>404</h1>
                <h2>Oh no! Parece que te encuentras perdido.</h2>
                <p>La página que deseas mirar no existe.
                    Haz clic en el siguiente boton para escapar de este portal.
                </p>
                <Link to="/Home" class="btn green">Inicio</Link>
